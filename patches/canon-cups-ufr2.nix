...
stdenv.mkDerivation rec {
  ...
  postPatch = ''
    ...
    substituteInPlace \
      cnrdrvcups-common-${version}/{Makefile,{backend,cngplp/src,rasterfilter}/Makefile.am,backend/config.h,rasterfilter/cnrasterproc.h} \
      cnrdrvcups-lb-${version}/{{cngplp,cngplp/files,pdftocpca}/Makefile.am,pdftocpca/pdftocpca.c} \
      cnrdrvcups-lb-${version}/ppd/{CNRCUPSMF8200CZJ,CNRCUPSMF720CZK,CNRCUPSMF8200CZS,CNRCUPSMF620CZJ,CNRCUPSMF720CZJ,CNRCUPSMF8000ZJ,CNRCUPSMF8300ZJ,CNRCUPSMF8300ZS,CNRCUPSMF8000CZK,CNRCUPSMF8300CZK,CNRCUPSMF8300CZJ,CNRCUPSMF8300ZK,CNRCUPSMF8500CZK,CNRCUPSMF8200CZK,CNRCUPSMF720CZS,CNRCUPSMF8000CZJ,CNRCUPSMF8500CZJ,CNRCUPSMF620CZK,CNRCUPSMF8300CZS,CNRCUPSMF8000ZS,CNRCUPSMF8500CZS,CNRCUPSMF8000CZS,CNRCUPSMF620CZS,CNRCUPSMF8000ZK}.ppd \
  ...
  installPhase = ''
    ...
    (
      ...
      wrapProgram $out/bin/cnrsdrvufr2 \
        ...
        --set NIX_REDIRECTS /usr/share/cnpkbidir=$out/share/cnpkbidir:/usr/bin/cnpkmoduleufr2r=$out/bin/cnpkmoduleufr2r:/usr/bin/cnjbigufr2=$out/bin/cnjbigufr2

      wrapProgram $out/bin/cnsetuputil2 \
        --set LD_PRELOAD "${libredirect}/lib/libredirect.so" \
        --set NIX_REDIRECTS /usr/share/cnsetuputil2=$out/share/cnsetuputil2:/usr/share/cnpkbidir=$out/share/cnpkbidir
    )
