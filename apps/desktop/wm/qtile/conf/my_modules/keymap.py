...
keys = [
    ...
    Key([GLOBAL.mod, "shift"], "h", lazy.layout.shuffle_left(), desc="Move window to the left"),
    Key([GLOBAL.mod, "shift"], "l", lazy.layout.shuffle_right(), desc="Move window to the right"),
    Key([GLOBAL.mod, "shift"], "j", lazy.layout.shuffle_down(), lazy.layout.section_down(), desc="Move window down"),
    Key([GLOBAL.mod, "shift"], "k", lazy.layout.shuffle_up(), lazy.layout.section_up(), desc="Move window up"),
    Key([GLOBAL.mod, "control"], "c", lazy.window.kill(), desc="Kill focused window"),
    # Operate window between workspaces
    Key([GLOBAL.mod, "control"], "h", focus_previous_group(), keep_pinp(), desc="focus prev group"),
    Key([GLOBAL.mod, "control"], "l", focus_next_group(), keep_pinp(), desc="focus next group"),
    Key([GLOBAL.mod, "control"], "j", window_to_previous_group(), keep_pinp(), desc="window to prev group"),
    Key([GLOBAL.mod, "control"], "k", window_to_next_group(), keep_pinp(), desc="window to next group"),
    ...
    # Launch rofi
    Key([GLOBAL.mod], "space", lazy.spawn("rofi -combi-modi window,drun -show combi"), desc="show rofi"),
    Key([GLOBAL.mod, "shift"], "space", lazy.spawn("rofi -show run"), desc="run rofi as shell mode"),
    Key(
        [GLOBAL.mod, "control"],
        "space",
...
mouse = [
    Drag([GLOBAL.mod], "Button1", lazy.window.set_position_floating(), start=lazy.window.get_position()),
    Drag([GLOBAL.mod, "shift"], "Button1", lazy.window.set_size_floating(), start=lazy.window.get_size()),
]
