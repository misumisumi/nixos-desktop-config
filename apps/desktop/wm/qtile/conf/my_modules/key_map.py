...
keys = [
    ...
    Key([PARAM.mod], "f", lazy.window.toggle_floating()),
    Key([PARAM.mod, "shift"], "f", lazy.window.toggle_maximize()),
    Key([PARAM.mod, "control", "shift"], "f", lazy.window.toggle_fullscreen()),
    # Exit and Reload
    ...
    # Screenshot
    Key(
        [], "Print", lazy.spawn("flameshot full -p {}".format(str(PARAM.capture_path)))
    ),
