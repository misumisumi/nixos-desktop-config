...
def set_keys():
    def _set_keys(mod: str):
        _keys = [
            Key(
                [mod], "Return", lazy.spawn(GlobalConf.terminal), desc="Launch terminal"
            ),
            Key(
                [mod, "shift"],
                "Return",
            ...
            Key(
                [mod],
                "p",
                F.focus_cycle_screen(backward=True),
                desc="focus prev screen",
            ),
            Key(
                [mod, "shift"],
                "n",
            ...
            Key(
                ...
                "e",
                lazy.spawn("rofimoji"),
                desc="show rofimoji by default config",
            ),
            Key(
                [mod, "control"],
                "e",
                lazy.spawn("rofimoji -f nerd"),
                desc="show rofimoji for searting nerd",
            ),
            # Toggle application
        ...
        if GlobalConf.pentablet is not None:
            _keys += [
                Key(
                    ...
                    "t",
                    F.to_from_pentablet(),
                    desc="forcus pentablet",
                ),
                Key(
                    [mod, "shift"],
                    "t",
                    F.to_from_pentablet(move=True),
                    F.keep_pinp(),
                    F.update_pinp_screen_idx(),
